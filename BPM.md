...
> [!TIP]
> Managing of a sales team; not only from a personnel management point of view, but also through the sales cycle with sales professionals.
...
> [!TIP]
> Management of reviewing employee performance.  This includes the tools that are used, the frequency of the reviews, and how the reviews are used within the organization. 
...
> [!TIP]
> Examination of a process in order to see if it could be streamlined. 
